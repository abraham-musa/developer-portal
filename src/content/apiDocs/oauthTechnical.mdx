...
<pre className="va-api-code-block-with-tip">
  <code>
...
<div className="va-api-code-tip">
  (⚠️Be sure to replace <code>&lt;yourRedirectURL&gt;</code> with the redirect URL that you provided during registration)
</div>
...
<pre className="va-api-code-block-with-tip">
  <code className="language-http">
    HTTP/1.1 <span className="hljs-number">302</span> Found<br />
    <span className="hljs-attribute">Location</span>: https://dev-api.va.gov/oauth2/authorize?<br />
      &nbsp;&nbsp;client_id=s6BhdRkqt3<br />
      &nbsp;&nbsp;&amp;response_type=id_token<br />
      &nbsp;&nbsp;&amp;response_mode=fragment<br />
      &nbsp;&nbsp;&amp;redirect_uri=&lt;yourRedirectURL&gt;<br />
...
<pre className="va-api-code-block-with-tip">
  <code className="language-http">
    <span className="hljs-keyword">GET</span> <span className="hljs-string">&lt;yourRedirectURL&gt;#<br />
      &nbsp;&nbsp;id_token=SlAV32hkKG<br />
      &nbsp;&nbsp;&amp;access_token=SlAV32hkKG<br />
      &nbsp;&nbsp;&amp;token_type=Bearer<br />
      &nbsp;&nbsp;&amp;expires_in=3600<br />
      &nbsp;&nbsp;&amp;scope=openid%20profile%20email<br />
      &nbsp;&nbsp;&amp;state=af0ifjsldkj</span> HTTP/1.1<br />
    <span className="hljs-attribute">Host</span>: &lt;yourRedirectHost&gt;
  </code>
</pre>
<div className="va-api-code-tip">
  (⚠️Be sure to replace <code>&lt;yourRedirectURL&gt;</code> with the redirect URL that you provided during registration, and `&lt;yourRedirectHost&gt;` with the host part of the redirect URL that you provided during registration)
</div>
...
<pre className="va-api-code-block-with-tip">
  <code className="language-http">
    ...
    <span className="hljs-attribute">Location</span>: https://dev-api.va.gov/oauth2/authorize?<br />
      ...
      &nbsp;&nbsp;&amp;scope=openid%20profile%20email%20offline_access<br />
      &nbsp;&nbsp;&amp;client_id=s6BhdRkqt3<br />
...
<pre className="va-api-code-block-with-tip">
  <code className="language-http">
    <span className="hljs-keyword">POST</span> <span className="hljs-string">/oauth2/token</span> HTTP/1.1<br />
    <span className="hljs-attribute">Host</span>: dev-api.va.gov<br />
    <span className="hljs-attribute">Content-Type</span>: application/x-www-form-urlencoded<br />
    <span className="hljs-attribute">Authorization</span>: Basic &#123;base64 encoded *client id* + ':' + *client secret*&#125;<br />
    <br />
    <span className="hljs-plaintext">
...
<pre className="va-api-code-block-with-tip">
  <code>
    <span className="hljs-keyword">const</span> &#123; Issuer &#125; = <span className="hljs-built_in">require</span>(<span className="hljs-string">'openid-client'</span>)&#59;<br />
    <span className="hljs-keyword">const</span> ROOT_URL = <span className="hljs-string">'https://dev-api.va.gov/oauth2/.well-known/openid-configuration'</span>&#59;<br />
    <span className="hljs-keyword">const</span> client_id = <span className="hljs-string">'your_client_id'</span>&#59;<br />
    <span className="hljs-keyword">const</span> client_secret = <span className="hljs-string">'your_client_secret'</span>&#59;<br />
    <br />
    <span className="hljs-keyword">const</span> createClient = <span className="hljs-keyword">async</span> () => &#123;<br />
      &nbsp;&nbsp;Issuer.defaultHttpOptions = &#123; timeout: <span className="hljs-number">2500</span> &#125;&#59;<br />
      &nbsp;&nbsp;return Issuer.discover(ROOT_URL).then(issuer => &#123;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;<span className="hljs-keyword">return new</span> issuer.Client(&#123;<br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client_id,<br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client_secret,< br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;redirect_uris: [<br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span className="hljs-string">'&lt;yourRedirectURL&gt;'<br /></span>
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;],<br />
        &nbsp;&nbsp;&nbsp;&nbsp;&#125;)&#59;<br />
      &nbsp;&nbsp;&#125;)&#59;<br />
    &#125;
