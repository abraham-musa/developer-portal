...
<pre className="va-api-code-block-with-tip">
  <code>
    ...
    Location: https://dev-api.va.gov/oauth2/authorize?<br />
...
<pre className="va-api-code-block-with-tip">
  <code>
    POST /oauth2/token HTTP/1.1<br />
    Host: dev-api.va.gov<br />
    Content-Type: application/x-www-form-urlencoded<br />
    Authorization: Basic &#123;base64 encoded *client id* + ':' + *client secret*&#125;<br />
    <br />
    grant_type=authorization_code&amp;code=z92dapo5&amp;state=af0ifjsldkj&amp;redirect_uri=&lt;yourRedirectURL&gt;<br />
  </code>
</pre>
<div className="va-api-code-tip">
  (⚠️Be sure to replace <code>&lt;yourRedirectURL&gt;</code> with the redirect URL that you provided during registration)
...
<pre className="va-api-code-block-with-tip">
  <code>
    const &#123; Issuer &#123; = require('openid-client')&semi;<br />
    const ROOT_URL = 'https://dev-api.va.gov/oauth2/.well-known/openid-configuration'&semi;<br />
    const client_id = 'your_client_id'&semi;<br />
    const client_secret = 'your_client_secret'&semi;<br />
    <br />
    const createClient = async () => &#123;<br />
      &nbsp;&nbsp;Issuer.defaultHttpOptions = &#123; timeout: 2500 &#123;&semi;<br />
      &nbsp;&nbsp;return Issuer.discover(ROOT_URL).then(issuer => &#123;<br />
        &nbsp;&nbsp;&nbsp;&nbsp;return new issuer.Client(&#123;<br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client_id,<br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;client_secret,< br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;redirect_uris: [<br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'&lt;yourRedirectURL&gt;'<br />
